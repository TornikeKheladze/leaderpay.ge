...
<div class="container">
    ...
    <div role="form">
        <div class="panel panel-primary setup-content" id="step-1">
            ...
            <form action="wallet_step_1.php" method="post">
        ...
        <div class="panel panel-primary setup-content" id="step-2">
            ...
            <form action="wallet_step_2.php" method="post">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="control-label">Agen ID</label>
                        <input id="agent_id" name="agent_id" maxlength="100" type="text" required="required" class="form-control" placeholder="Enter Agent ID" value="31"/>
                    ...
                    <div class="form-group">
                        ...
                        <input id="first_name" name="first_name" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter First Name" value="Dato" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Last Name</label>
                        <input id="last_name" name="last_name" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter Last Name" value="Kifshidze" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Birth Date</label>
                        <input id="birth_date" name="birth_date" maxlength="200" type="text" required="required" class="form-control" placeholder="Enter Birth Date" value="1999-04-25" />
                    </div>
                    <input class="btn btn-primary nextBtn pull-right" type="submit" value="Next">
                </div>
            </form>
        ...
        <div class="panel panel-primary setup-content" id="step-3">
            ...
            <form action="wallet_step_3.php" method="post">
                <div class="panel-body">
                    <div class="form-group">
                        <label class="control-label">Agen ID</label>
                        <input id="agent_id" name="agent_id" maxlength="100" type="text" required="required" class="form-control" placeholder="Enter Agent ID" value="31"/>
