              ...
              if (!empty($services_lst['services'])) {
                ...
                foreach ($services_lst['services'] as $service) {
                  ...
                  if ($service['id'] == 46) {
                    ...
                    <a class="service-search-item none" alt="<?php echo $service['lang']['GE']; ?>, <?php echo $service['lang']['EN']; ?>, <?php echo $service['lang']['RU']; ?>" title="<?php echo $service['lang'][$langs]; ?>" href="profile.php?action=pay&id=<?php echo $service['id']; ?>">
