            ...
            <div class="row">
                <div class="col-md-2 col-sm-2 col-xs-9">
                    ...
                    <?php if ($db->check_auch() === true) { ?>
                        ...
                        <a href="https://apw.ge/profile.php" class="logo" style="background-image: url('/assets/img/lp_text.png?')"></a>


                    <?php } else { ?>

                        <a href="https://apw.ge/" class="logo" style="background-image: url('/assets/img/lp_text.png?')"></a>
                ...
                <div class="col-md-10 col-sm-10 hidden-xs text-right clear" style="padding-left: 120px;">
                    ...
                    <div class="head-elements clear" style="height: 50px;">
                        <div class="">
                            <!--<div class="title"><span>ფავორიტები</span></div>
                            <i class="star drop" rel="top_fav"  title="საყვარელი სერვისები"></i>-->
                        </div>
                        <div class="item curses">

                        </div> <!-- end item -->
                        <div class="item">
                            <div class="title"><span>სტატისტიკა</span></div>
                            <div class="item operations" title="ოპერაციები">
                            </div>
                            <div class="item users" title="მომხმარებლები">
                            </div>
                        </div> <!-- end item -->
                    </div><!-- end head-elements -->
                    <?php
