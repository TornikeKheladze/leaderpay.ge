<?php
    ...
    if (isset($post['wallet_number']) && isset($post['g-recaptcha-response']) && !isset($post['mobile'])) {
        ...
        $wallet_number = htmlspecialchars(trim($post['wallet_number']), ENT_QUOTES);
        ...
        $wallet_number = htmlspecialchars(trim($post['wallet_number']), ENT_QUOTES);
        $mobile = htmlspecialchars(trim($post['mobile']), ENT_QUOTES);
        ...
        if ($mobile == $db_mobile) {
            ...
            $smsParams = [
                'number' => $mobile,
                'text' => "leaderpay.ge-is safulis nomeri: $wallet_number axali paroli: $new_pass",
            ];
